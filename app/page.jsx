...
//           ease: "power2.out",
//         },
//         "-=0.6" // Overlap slightly with navbar or tune as needed
//       )
...
//     // Animate floating cards into view after rectangle expansion
//     // gsap.utils.toArray(".floating-card").forEach((card, i) => {
//     //   gsap.to(card, {
//     //     scrollTrigger: {
//     //       trigger: rectangle,
//     //       start: "top 60%", // trigger as user scrolls into hero
...
//     gsap.utils.toArray(".floating-card").forEach((card, i) => {
//       const parallaxOffset = [100, 60, 80][i]; // unique Y offset for parallax
//       const baseStart = 60; // base start threshold percentage
...
//           scrollTrigger: {
//             trigger: rectangle,
//             start: `top ${baseStart - i * 10}%`, // staggered start (e.g., 60%, 55%, 50%)
//             end: "bottom top",
//             scrub: true,
//           },
//         }
...
//           </div>
//         </div>
//         {/* Floating testimonial cards inside hero section */}
//         {[
//           {
...
//               left: card.left,
//               transform: "translate(-50%, -50%)",
//               backgroundColor: "rgba(255, 255, 255, 0.15)", // transparent matte
//               backdropFilter: "blur(10px)", // matte effect
//               WebkitBackdropFilter: "blur(10px)",
//               borderRadius: "16px",
//               boxShadow: "0 12px 24px rgba(0,0,0,0.2)", // softer and deeper shadow
//               padding: "16px 20px",
//               display: "flex",
//               alignItems: "center",
//               minWidth: "260px",
...
//               zIndex: 4,
//               border: "1px solid rgba(255,255,255,0.2)", // light inner border for crispness
//             }}
//           >
//             <img
...
//                 boxShadow: `0 0 30px rgba(148, 0, 211, 0.4)`, // violet glow
//                 position: "absolute",
//                 top: "50%",
//                 left: "50%",
//                 transform: "translate(-50%, -50%)",
...
//       }}
//     >
//       {/* Hero Section Container - Fixed positioning */}
//       <div
//         style={{
//           position: "relative",
//           height: "100vh",
...
//           position: "relative",
//           zIndex: 1,
//           marginTop: "100vh", // Push content below the hero
//         }}
//       >
//         <CategorySection />
